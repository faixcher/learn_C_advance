...
void func2(){
	...
	func3();
	printf("\t\t[back in fuc2] i @ 0x%016x = %d\n",&i,i);
	printf("\t\t[back in fun2] j @ 0x%016x = %d\n",&j,j);
}
void func1(){
	int i = 5;
...
int main(){
	...
	printf("[in main] j @ 0x%016x = %d\n",&j,j);
	func1();
	printf("\t[back in main] i @ 0x%016x = %d\n",&i,i);
        printf("\t[back in main] j @ 0x%016x = %d\n",&j,j);
